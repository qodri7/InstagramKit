...
Class InstagramPostUploadAPI
{
	...
	public function ProcessUploadPhoto($binary_file,$upload_id = false,$upload_album = false)
	{
		...
		$access = InstagramHelperAPI::curl($url, $filedata , $headers , $this->cookie , InstagramUserAgentAPI::GenerateStatic());
	...
	public function ConfigurePhoto($upload_id,$caption)
	{
		...
		$access = InstagramHelperAPI::curl($url, $postdata , false , $this->cookie , InstagramUserAgentAPI::GenerateStatic());
